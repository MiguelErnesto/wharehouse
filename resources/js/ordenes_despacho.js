export default class ObjectClass {
  ...
  onValidate(evt) {
    ...
    if (document.getElementById('cliente_id').value.length == 0) {
      alert('Debe completar todos los datos de la Orden')
      document.getElementById('cliente_id').className =
        'form-control border border-danger'
      document.getElementById('cliente_id').placeholder =
        '--- Valor requerido ---'
    ...
    if (document.getElementById('tipo_salida').value == 'V') {
      if (document.getElementById('vale_id').value.length == 0) {
        alert('Debe completar todos los datos de la Orden')
        document.getElementById('vale_id').className =
          'form-control border border-danger'
        document.getElementById('vale_id').placeholder =
          '--- Valor requerido ---'
    ...
    if (document.getElementById('tipo_salida').value == 'T') {
      if (document.getElementById('transferencia_id').value.length == 0) {
        ...
        document.getElementById('transferencia_id').className =
          'form-control border border-danger'
        document.getElementById('transferencia_id').placeholder =
          '--- Valor requerido ---'
