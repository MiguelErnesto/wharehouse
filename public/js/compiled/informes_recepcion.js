...
var InformesRecepcionClass = /*#__PURE__*/function () {
  function InformesRecepcionClass() {
    var _this = this,
        _document$getElementB,
        _document$querySelect;

    _classCallCheck(this, InformesRecepcionClass);
  ...
  return InformesRecepcionClass;
}();



var InformesRecepcion = /*#__PURE__*/function () {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            Handler = new InformesRecepcionClass();
  ...
  return function InformesRecepcion() {
