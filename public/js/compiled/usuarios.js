    ...
    value: function onValidate(evt) {
      ...
      if (window.location.pathname.includes('create')) {
        if (document.getElementById('password').value.length == 0) {
          ...
          document.getElementById('password').placeholder = '--- Valor requerido ---';
          document.getElementById('password').focus();
          return false;
        }

        if (document.getElementById('confirmar_password').value.length == 0) {
          document.getElementById('confirmar_password').className = 'form-control border border-danger';
          document.getElementById('confirmar_password').placeholder = '--- Valor requerido ---';
      ...
      if (window.location.pathname.includes('edit')) {
        if ((document.getElementById('password').value.length != 0 || document.getElementById('confirmar_password').value.length != 0) && document.getElementById('password').value != document.getElementById('confirmar_password').value) {
          alert('Las contraseñas no coinciden');
          return false;
        }
      }
