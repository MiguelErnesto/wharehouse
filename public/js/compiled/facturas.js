...
var ObjectClass = /*#__PURE__*/function () {
  function ObjectClass() {
    ...
    _defineProperty(this, "addListeners", function () {
      ...
      if (_this.btnVerDetalles) {
        for (var i = 0; i < _this.btnVerDetalles.length; i += 1) {
          _this.btnVerDetalles[i].addEventListener('click', function (evt) {
            return _this.onVerDetalles(evt);
          });
        }
      }
  ...
  _createClass(ObjectClass, [{
    ...
    value: function onPrint(evt) {
      ...
      window.open("facturas/imprimir/".concat(id), '_blank');
    }
  }, {
    key: "onExportPDF",
    value: function onExportPDF(evt) {
      ...
      if (confirm("\xBFDesea descargar esta informaci\xF3n en un PDF?")) {
        var id = evt.currentTarget.dataset.id;
        window.open("facturas/exportarPDF/".concat(id), '_blank');
      }
    }
  }, {
    key: "onVerDetalles",
    value: function onVerDetalles(evt) {
      evt.preventDefault();
      evt.stopPropagation();
      var id = evt.currentTarget.dataset.id;
      ...
      $.ajax({
        url: "facturas/getDetalles/".concat(id),
        type: 'get',
        dataType: 'json',
        context: this,
    ...
    key: "showProductos",
    value: function showProductos(productos) {
    ...
    value: function formated_datetime(fecha) {
      ...
      var fecha_formato = date + '-' + month + '-' + year;
    ...
    value: function onValidate(evt) {
      ...
      if (document.getElementById('moneda_pago').value.length == 0) {
        alert('Debe completar todos los datos de la Factura');
        document.getElementById('moneda_pago').className = 'form-control border border-danger';
        document.getElementById('moneda_pago').placeholder = '--- Valor requerido ---';
      ...
      if (document.getElementById('porciento').value.length == 0) {
        alert('Debe completar todos los datos de la Factura');
        document.getElementById('porciento').className = 'form-control border border-danger';
        document.getElementById('porciento').placeholder = '--- Valor requerido ---';
      ...
      if (document.getElementById('datos_registro').value.length == 0) {
        alert('Debe completar todos los datos de la Factura');
        document.getElementById('datos_registro').className = 'form-control border border-danger';
        document.getElementById('datos_registro').placeholder = '--- Valor requerido ---';
      ...
      if (document.getElementById('operaciones').value.length == 0) {
        alert('Debe completar todos los datos de la Factura');
        document.getElementById('operaciones').className = 'form-control border border-danger';
        document.getElementById('operaciones').placeholder = '--- Valor requerido ---';
      ...
      if (document.getElementById('transportista').value.length == 0) {
        alert('Debe completar todos los datos de la Factura');
        document.getElementById('transportista').className = 'form-control border border-danger';
        document.getElementById('transportista').placeholder = '--- Valor requerido ---';
      ...
      if (document.getElementById('persona_transportador').value.length == 0) {
        alert('Debe completar todos los datos de la Factura');
        document.getElementById('persona_transportador').className = 'form-control border border-danger';
        document.getElementById('persona_transportador').placeholder = '--- Valor requerido ---';
      ...
      var data = {
        ...
        persona_transportador: document.getElementById('persona_transportador').value,
