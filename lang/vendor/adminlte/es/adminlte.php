...
return [
    ...
    'register_a_new_membership' => 'Guardar una nueva cuenta',
    ...
    'register_message' => 'Guardar una nueva cuenta',
    ...
    'verify_check_your_email' =>
        'Antes de continuar, busque en su correo electrónico un enlace de verificación.',
    ...
    'remember_me_hint' =>
        'Mantenerme autenticado indefinidamente o hasta cerrar la sesión manualmente',
];
